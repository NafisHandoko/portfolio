    ...
    <Layout>
      ...
      <header className={styles.indexHeader}>
        ...
        <div className={styles.mainHeader}>
          ...
          <p>
            I am a 21 years old Computer Science student who loves to learn Web Development. Now i am using Reactjs and Nextjs for my recent project. Even though i&apos;m new, i&apos;ll keep trying to improve my skills as time goes on. If you need me or want to work with me, feel free to contact me
          </p>
      ...
      <section className={styles.aboutSkills}>
        <div className={styles.about} id="about" data-aos="fade-right" data-aos-offset="250">
          <h2>About Me</h2>
          <p>
            My journey in IT world started when I was 14. I was curious about how to make games and found that Python was suitable and the easiest one to learn. I used Pygame at that time. After a while I became interested in Cyber Security and use Python for automation. I also learned about Web Exploitation and that&apos;s when I started to dive down into Web Development, I started from PHP, after that I became interested in learning Frontend Development and try to master it. I started from using Vanilla CSS and JS then learned some frameworks and libraries like Bootstrap, Tailwindcss, jQuery, Reactjs, and now I&apos;m learning Jamstack using Nextjs for my personal projects.
          </p>
        </div>
