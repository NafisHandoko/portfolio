    ...
    <div className={styles.portItem2} data-aos="flip-left" data-aos-duration="3500" data-aos-offset="100">
      <figure className={styles.portFigure}>
        ...
        <figcaption className={styles.portFigcaption}>
          ...
          <div className={styles.portDemo}>
            <a className={styles.demoIcon} href={props.repo} target="_blank" rel="noreferrer"><i className="bi bi-github"></i></a>
            <a className={styles.demoIcon} href={props.demo} target="_blank" rel="noreferrer"><i className="bi bi-box-arrow-up-right"></i></a>
          </div>
        </figcaption>
